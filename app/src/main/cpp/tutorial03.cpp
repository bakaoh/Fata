...
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "TUT03", __VA_ARGS__))
...
extern C_LINKAGE DECLSPEC int tutorial03(int argc, char *argv[]) {
    return Tutorial03::run(argc,argv);
}