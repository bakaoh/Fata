...
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "TUT06", __VA_ARGS__))
...
extern C_LINKAGE DECLSPEC int tutorial06(int argc, char *argv[]) {
    return Tutorial06::run(argc, argv);
}